...
def normalize_text(doc, html_stripping=True, handle_omissions=True, accented_char_removal=True, text_lower_case=True, special_chars_removal=True, remove_digits=False, stopwords_removal=False, stopwords=None):
    # strip html
    if html_stripping:
...
# text = """
# Abana b'iwacu bakunda kunywa amata y'inka.
# """
# print(normalize_omissions(text))
